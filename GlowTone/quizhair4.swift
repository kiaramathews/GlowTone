        ...
        NavigationStack{
            ZStack{
                ...
                VStack {
                    ...
                    Text("Based on your results, the colors that best fit your hair color are, neutrals, greens, black, and reds")
                        .font(.title2)
                        .fontWeight(.regular)
...
struct quizhair4_Previews: PreviewProvider {
