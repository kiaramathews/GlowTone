        ...
        NavigationStack{
            ZStack{
                ...
                VStack {
                    ...
                    Text("Based on your eye color, the colors that best fit are, red, warm green tones, and purple.")
                        .font(.title2)
                        .fontWeight(.regular)
...
struct quizskin3_Previews: PreviewProvider {
