        ...
        NavigationStack{
            ZStack{
                ...
                VStack {
                    ...
                    Text("Based on your eye color, the colors that best fit are, white tones, light blue tones, and purple.")
                        .font(.title2)
                        .fontWeight(.regular)
...
struct quizskin2_Previews: PreviewProvider {
