        ...
        NavigationStack{
            ZStack{
                ...
                VStack {
                    ...
                    Text("Based on your results, the colors that best fit you best are, orange-red tones, creamy colors, dark brown, and earthy greens.")
                        .font(.title2)
                        .fontWeight(.regular)
...
struct quizhair2_Previews: PreviewProvider {
