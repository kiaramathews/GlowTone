        ...
        NavigationStack{
            ZStack{
                ...
                VStack {
                    ...
                    Text("Based on your eye color, the colors that best fit are, orange, copper, brown, blue and gold.")
                        .font(.title2)
                        .fontWeight(.regular)
                        ...
                        .overlay(
                            RoundedRectangle(cornerRadius: 10)
                                .stroke(/*@START_MENU_TOKEN@*/Color(red: 0.592, green: 0.794, blue: 0.999)/*@END_MENU_TOKEN@*/,
                                                              lineWidth: 4))
                        .padding()
                    Text("Pro tip: The jewelry that looks best on you are, gold, and silver.")
                        .font(.title)
                        .fontWeight(.light)
                        .foregroundColor(Color.white)
                        .multilineTextAlignment(.center)
...
struct quizeye5_Previews: PreviewProvider {
